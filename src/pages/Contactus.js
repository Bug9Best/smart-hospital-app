    ...
    <base.View style={styles.container}>
      <base.View style={styles.box}>
        ...
        <base.Text style={{ marginTop: 10, fontSize: 12, fontWeight: 400, marginRight: 50 }}>
          <base.Image source={require("../assets/image/facebooklogo.png")} style={{ width: 20, height: 20, borderRadius: 100 }} />
          Facebook : ศูนย์การแพทย์ สจล. KMITL Medical Centre
        </base.Text>
        <base.Text style={{ marginTop: 10, fontSize: 12, fontWeight: 400 }}>
          <base.Image source={require("../assets/image/Line.png")} style={{ width: 20, height: 20, borderRadius: 100 }} />
